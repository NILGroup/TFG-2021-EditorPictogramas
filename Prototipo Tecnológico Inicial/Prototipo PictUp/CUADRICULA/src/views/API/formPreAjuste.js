...
import {colourButton} from '../../index'
...
class FormPicto extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            url: "https://static.arasaac.org/pictograms/6009/6009_500.png",
    ...
    createUrl() {
        ...
        this.setState({
            url: "https://static.arasaac.org/pictograms/6009/6009" + query + "_500.png"
        })
        ...
        return (
            <div className="row" >
                <select className="form-control mb-3" onChange={this.handleTime} disabled={(!this.state.isColorized || this.state.isPlural)}>
                    <option defaultValue value="present">Tiempo verbal por defecto</option>
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Preajustes de pictos</h5>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="modal-footer">
                            <button className="form-control btn btn-primary" onClick={() => this.handleSubmit()}>
                                <span className="fas fa-save"> </span> Guardar ajustes
                            </button>
                        </div>
                    </div>
                </div>
