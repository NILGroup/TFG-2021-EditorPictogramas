...
document.addEventListener('newUploadPhoto', () => {
    console.log('dom content loaded');

    document.querySelector('#loader').addEventListener('change', doFile);
...
function doImageTest() {
    ...
    req.onsuccess = function (e) {
        ...
        console.log('data:image/jpeg;base64,' + btoa(record.data))
    }
}